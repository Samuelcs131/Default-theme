import { iThemeDefault } from "../types/themeDefault"

export const themeDark: iThemeDefault = {
    // PALLETE
    pallete: {
        common: {
            black: '#000', white: '#fff'
        ...
        primary: {
            main: '#90caf9', ligth: '#e3f2fd', dark: '#42a5f5', 
            constrastText: 'rgba(0, 0, 0, 0.87)'
        },
        secondary: {
            main: '#ce93d8', ligth: '#f3e5f5', dark: '#ab47bc', 
            constrastText: 'rgba(0, 0, 0, 0.87)'
        },
        error: {
            main: '#f44336', ligth: '#e57373', dark: '#d32f2f', 
            constrastText: '#fff'
        },
        warning: {
            main: '#ffa726', ligth: '#ffb74d', dark: '#f57c00', 
            constrastText: 'rgba(0, 0, 0, 0.87)'
        },
        info: {
            main: '#29b6f6', ligth: '#4fc3f7', dark: '#0288d1', 
            constrastText: 'rgba(0, 0, 0, 0.87)'
        },
        success: {
            main: '#66bb6a', ligth: '#81c784', dark: '#388e3c', constrastText: 'rgba(0, 0, 0, 0.87)'
        },
        grey: {
